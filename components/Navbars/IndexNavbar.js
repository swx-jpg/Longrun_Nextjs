...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav id="idNavHeader" className="top-0 left-0 fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg  bg-transparent">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <Link href="/">
              <a
                ...
                href="#pablo"
              >
                <img className="" src="./img/Slider/longrun_logo.png" alt="Longrun Music Logo" />
              </a>
            </Link>
            <button
          ...
          <div
            className={
              "lg:flex flex-grow items-center bg-black lg:border-1 lg:border-white lg:bg-opacity-0 lg:shadow-none" +
